...
(function(){
    ...
    const q1 = new Question('Is JavaScript the coolest programming Language in world?'
                                , ['Yes', 'No'], 0);
    ...
    const gameStart = function(){
        ...
        targetQuestion.displayQuestion()
        
        let ans =  prompt('Please select correct answer');

        console.log(ans);

        if(ans !== 'exit'){
            targetQuestion.checkAnswer(parseInt(ans), keepScore);
